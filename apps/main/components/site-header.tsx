...
export function SiteHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 py-6 bg-gradient-to-b from-black/80 to-transparent pointer-events-none">
      <div className="flex items-center pointer-events-auto">
        <Link href="/" className="text-white text-xl md:text-2xl font-semibold tracking-[0.25em] uppercase" aria-label="VAVAW Ecosystem Home">
          VAVAW
        </Link>
      </div>
